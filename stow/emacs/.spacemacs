...
This function should only modify configuration layer settings."
  (setq-default
   ...
   '(go
     yaml
     (javascript :variables tern-command '("node" "/home/henning/.dots/stow/nvm/.nvm/versions/node/v6.3.1/bin/tern"))
     ;; ----------------------------------------------------------------
...
(defun dotspacemacs/user-config ()
  ...
  "Keybindings"
  (define-key evil-motion-state-map (kbd "¨") (lambda () (interactive) (evil-goto-mark ?`)))
